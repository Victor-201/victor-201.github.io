    ...
    <>
      <div
        ...
        className={cn(
          ...
          "jelly-blob fixed left-0 top-0 rounded-lg z-[9999] pointer-events-none will-change-transform",
      ...
      ></div>
      <div
        className="w-3 h-3 rounded-full fixed translate-x-[-50%] translate-y-[-50%] pointer-events-none transition-none duration-300 z-[9999]"
        style={{
          top: y,
          left: x,
          backdropFilter: "invert(100%)",
